...
//            make_init(group[i], frand(1.5));
    ...
    void update_item(DE_item& item){
        ...
        //        if(frand(1) > 0.8) {
//        memcpy(temp.video_list, item.video_list, sizeof(temp));
//
//        int p;
//        do {
...
//        int q;
////            do {
//        q = rand() % global->graph[p].size();
////            } while (temp.video_list[q] == 0);
//        q = global->graph[p][q];
//        temp.video_list[p] = 0;
...
//                else
                    temp.video_list[i] = best_item.video_list[i]
                                     + frand(2) * (group[a].video_list[i] + group[b].video_list[i]
                                                   - group[c].video_list[i] - group[d].video_list[i]) + 0.5;
                temp.video_list[i] = std::min(global->capSum[i], temp.video_list[i]);
